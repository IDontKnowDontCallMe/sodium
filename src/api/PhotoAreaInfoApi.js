...
export function searchPhotosApi(param) {

    console.log('api:searchPhotos');
    console.log(param)
...
export function getPhotoOfThemeApi(param) {

    console.log('api:getPhotoOfTheme');
    console.log(param)
    ...
    return request(backendAddress+'/getPhotosOfTheme',{
        method: 'POST',
        headers: headers,
